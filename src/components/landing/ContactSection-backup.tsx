...
export default function ContactSection() {
  ...
  const [formData, setFormData] = useState({
    ...
    subject: '',
    message: '',
    captcha: '' // Menambahkan captcha ke form data
  });
  ...
  useEffect(() => {
    fetchSettings();
    generateCaptcha(); // Menghasilkan captcha saat komponen dimuat
  }, []);
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{settings?.whatsapp_number || '+62 813-5682-2255'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{settings?.company_email || 'info@murbaykonveksi.com'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      {settings?.company_address || 'Jl. Industri No. 123, Jakarta Selatan'}
                    </p>
                  </div>
                </div>
              </div>
