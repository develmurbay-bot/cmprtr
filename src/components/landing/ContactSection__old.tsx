    ...
    try {
      ...
      if (data.success && data.settings) {
        ...
        const mappedSettings: Settings = {
          contact_phone: settingsObj.company_phone || settingsObj.phone || '+62 812-3456-7890',
          contact_email: settingsObj.company_email || settingsObj.email || 'info@murbaykonveksi.com',
          contact_address: settingsObj.company_address || settingsObj.address || 'Jl. Industri No. 123, Jakarta Selatan',
