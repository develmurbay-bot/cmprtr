      ...
      <div className="p-6 max-w-6xl mx-auto">
        ...
        <Tabs defaultValue="company" className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-1">
            <TabsTrigger value="company" className="text-xs sm:text-sm">Informasi Toko</TabsTrigger>
            <TabsTrigger value="contact" className="text-xs sm:text-sm">Kontak</TabsTrigger>
            <TabsTrigger value="about" className="text-xs sm:text-sm">Tentang Kami</TabsTrigger>
            <TabsTrigger value="social" className="text-xs sm:text-sm">Media Sosial</TabsTrigger>
            <TabsTrigger value="maps" className="text-xs sm:text-sm">Peta & Jam</TabsTrigger>
            <TabsTrigger value="display" className="text-xs sm:text-sm">Tampilan</TabsTrigger>
            <TabsTrigger value="watermark" className="text-xs sm:text-sm">Watermark</TabsTrigger>
          ...
          {/* Section Display Settings Tab */}
          <TabsContent value="display">
            <Card>
              <CardHeader>
                <CardTitle>Pengaturan Tampilan Section</CardTitle>
                <CardDescription>
                  Kelola section mana yang ditampilkan di halaman utama dan berapa banyak item yang ditampilkan
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {/* Services Section */}
                <div className="border rounded-lg p-4 space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-medium">Section Layanan</h4>
                ...
                <div className="border rounded-lg p-4 space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-medium">Section Galeri</h4>
                  ...
                  {settings.gallery_enabled === 'true' && (
                    <div className="space-y-2">
                      <Label htmlFor="gallery_show_count">Jumlah Gambar yang Ditampilkan</Label>
                      <Input
                ...
                <div className="border rounded-lg p-4 space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-medium">Section Berita/Artikel</h4>
                ...
                <div className="border rounded-lg p-4 space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-medium">Section Testimoni</h4>
