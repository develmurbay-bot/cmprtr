...
export default function SettingsPage() {
  const [settings, setSettings] = useState<Settings>({
    ...
    footer_text: '',
    footer_copyright_text: 'Semua hak cipta dilindungi.',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6 max-w-6xl mx-auto">
        ...
        <Tabs defaultValue="company" className="space-y-6">
          ...
          {/* Maps, Operating Hours & Footer Tab */}
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Kelola jam operasional untuk footer
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleInputChange('business_hours_weekday', e.target.value)}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleInputChange('business_hours_saturday', e.target.value)}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleInputChange('business_hours_sunday', e.target.value)}
                        placeholder="Tutup"
                      />
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="footer_text">Teks Deskripsi Footer</Label>
                      <Textarea
                        id="footer_text"
                        value={settings.footer_text}
                        onChange={(e) => handleInputChange('footer_text', e.target.value)}
                        placeholder="Perusahaan konveksi terpercaya yang telah melayani berbagai kebutuhan fashion dan garmen dengan komitmen tinggi terhadap kualitas dan kepuasan pelanggan."
                        rows={3}
                      />
                      <p className="text-sm text-gray-500">
                        Jika kosong, akan menggunakan deskripsi perusahaan
                      </p>
                    </div>

                    <div className="space-y-2">
                      <Label htmlFor="footer_copyright_text">Teks Copyright</Label>
                      <Input
                        id="footer_copyright_text"
                        value={settings.footer_copyright_text}
                        onChange={(e) => handleInputChange('footer_copyright_text', e.target.value)}
                    ...
                    <div>
                      <h3 className="text-lg font-semibold mb-4">Informasi Kontak Footer</h3>
                      <div className="space-y-4">
                        <div className="space-y-2">
                          <Label htmlFor="company_address">Alamat Perusahaan (Footer)</Label>
                          <Input
                            id="company_address"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="company_city">Kota (Footer)</Label>
                          <Input
                            id="company_city"
                            value={settings.company_city}
                            onChange={(e) => handleInputChange('company_city', e.target.value)}
                            placeholder="Rajabasa Jaya, Bandar Lampung"
                          />
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="space-y-2">
                            <Label htmlFor="company_phone">Telepon Footer</Label>
                            <Input
                              id="company_phone"
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="company_email">Email Footer</Label>
                            <Input
                              id="company_email"
                              value={settings.company_email}
                              onChange={(e) => handleInputChange('company_email', e.target.value)}
                              placeholder="info@murbaykonveksi.com"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold mb-4">Social Media Footer</h3>
                      <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                          <Switch
                            id="footer_show_social_links"
                            checked={settings.footer_show_social_links === 'true'}
                            onCheckedChange={(checked) => handleInputChange('footer_show_social_links', checked ? 'true' : 'false')}
                          />
                          <Label htmlFor="footer_show_social_links">Tampilkan Social Media di Footer</Label>
                        </div>

                        {settings.footer_show_social_links === 'true' && (
                          <div className="space-y-4">
                            <div className="space-y-2">
