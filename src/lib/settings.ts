...
export const getDefaultSettings = (): AppSettings => ({
  ...
  footer_text: "Perusahaan konveksi terpercaya yang telah melayani berbagai kebutuhan fashion dan garmen dengan komitmen tinggi terhadap kualitas dan kepuasan pelanggan._footerRF",
  footer_copyright_text: "Semua hak cipta dilindungi.footer_rf",
